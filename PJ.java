...
public class PJ {
    ...
    public static void playGame() {
        ...
        while (true) {
            ...
            if (instruction.equals("help")) {
                ...
                System.out.println("输入rule查看游戏规则");
            ...
            if (player) {//  玩家判断
                ...
                //  胜负判断
                if (search("1鼠 ", "2猫 ", "3狼 ", "4狗 ", "5豹 ", "6虎 ", "7狮 ", "8象 ") == 0) {
                ...
                //  胜负判断
                if (search(" 鼠1", " 猫2", " 狼3", " 狗4", " 豹5", " 虎6", " 狮7", " 象8") == 0) {
    ...
    public static int[] animalRowAndColumn(String animal) {
        ...
        for (int i = 0; i < 7; i++) {
            for (int j = 0; j < 9; j++) {
                if (PJ.animal[i][j].equals(animal)) {
                    animalRC[0] = i;
                    animalRC[1] = j;
                    break stop;
                }
    ...
    public static boolean moveTigerLion(int moveAnimalRow, int moveAnimalColumn, int x, int y, String lion, String enemyMouse, String tiger) {
        ...
        if (animal[moveAnimalRow][moveAnimalColumn].equals(lion)
            ...
            } else if (animal[moveAnimalRow][moveAnimalColumn].substring(0, 1).equals(animal[moveAnimalRow + 3 * x][moveAnimalColumn].substring(0, 1))
                    || animal[moveAnimalRow][moveAnimalColumn].substring(2, 3).equals(animal[moveAnimalRow + 3 * x][moveAnimalColumn].substring(2, 3))) {
            ...
            } else if (animal[moveAnimalRow][moveAnimalColumn].substring(0, 1).equals(animal[moveAnimalRow][moveAnimalColumn + 4 * y].substring(0, 1))
                    || animal[moveAnimalRow][moveAnimalColumn].substring(2, 3).equals(animal[moveAnimalRow][moveAnimalColumn + 4 * y].substring(2, 3))) {
    ...
    //  判断是否还有动物,a、b、c、d、e、f、g、h代表同一阵营的八个动物
    public static int search(String a, String b, String c, String d, String e, String f, String g, String h) {
        int q = 0;
        stop:
        for (int i = 0; i < 7; i++) {
            for (int j = 0; j < 9; j++) {
